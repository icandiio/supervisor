...
class http_channel(asynchat.async_chat):  # @important 处理请求间的交互
...
class http_server(asyncore.dispatcher):
    ...
    def handle_accept(self):
        ...
        try:
            conn, addr = self.accept()  # @important 处理请求连接
        except socket.error:
        ...
        self.channel_class(self, conn, addr)  # @important 新的连接请求交给该类的实例来处理
